...
!(function(n) {
				...
				return (
					(c.prototype.set = function(t, e, n) {
						...
						t: for (var o in t) {
							...
							var p = r[o];
							this.isUndef(p) ||
								((c.Signal && p instanceof c.Signal) || (c.Param && p instanceof c.Param)
									? p.value !== e && (this.isUndef(n) ? (p.value = e) : p.rampTo(e, n))
									: p instanceof AudioParam
										? p.value !== e && (p.value = e)
										: p instanceof c ? p.set(e) : p !== e && (r[o] = e));
						}
						return this;
					}),
					...
					(c.State = { Started: 'started', Stopped: 'stopped', Paused: 'paused' }),
				...
				return (
					...
					(p5.prototype._mathChain = function(t, e, n, i, o) {
						for (var r in t.mathOps)
							t.mathOps[r] instanceof o &&
								(t.mathOps[r].dispose(), (n = r) < t.mathOps.length - 1 && (i = t.mathOps[r + 1]));
						return (
					...
					}),
					{
						convertToWav: function(t) {
							var e,
								n = (function(t, e) {
									for (var n = t.length + e.length, i = new Float32Array(n), o = 0, r = 0; r < n; )
										(i[r++] = t[o]), (i[r++] = e[o]), o++;
									return i;
						...
						safeBufferSize: function(t) {
							...
							return (
								n instanceof ScriptProcessorNode && (e = n.bufferSize), n.disconnect(), (n = null), e
							);
						}
					}
				);
							...
							return this.isNumber(t)
								...
								: this.isUndef(t)
									...
									: this.isString(t)
										...
										: t instanceof e.TimeBase ? t.toSeconds() : void 0;
						}),
						(e.prototype.toFrequency = function(t) {
							return this.isNumber(t)
								...
								: this.isString(t) || this.isUndef(t)
									...
									: t instanceof e.TimeBase ? t.toFrequency() : void 0;
						}),
						(e.prototype.toTicks = function(t) {
							return this.isNumber(t) || this.isString(t)
								? new e.TransportTime(t).toTicks()
								: this.isUndef(t) ? e.Transport.ticks : t instanceof e.TimeBase ? t.toTicks() : void 0;
						}),
						e
					);
				}.apply(e, i)) || (t.exports = o);
				...
				(o = function(u) {
					...
					return (
						...
						(u.TimelineSignal.prototype.setValueCurveAtTime = function(t, e, n, i) {
							...
							(e = this.toSeconds(e)),
								(n = this.toSeconds(n)),
								this._events.add({ type: u.TimelineSignal.Type.Curve, value: o, time: e, duration: n }),
						...
						(u.TimelineSignal.prototype.getValueAtTime = function(t) {
							...
							if (null === n) i = this._initial;
								...
								(o = null === r ? this._initial : r.value),
									(i = this._exponentialApproach(n.time, o, n.value, n.constant, t));
							} else
								i =
						...
						(u.TimelineSignal.prototype._exponentialApproach = function(t, e, n, i, o) {
			...
			(i = function(t) {
				...
				(p5.Oscillator = function(t, e) {
					...
					(this.started = !1),
						...
						this.oscillator.frequency.setValueAtTime(this.f, s.audiocontext.currentTime),
					...
					(p5.Oscillator.prototype.start = function(t, e) {
						...
						if (!this.started) {
							...
							for (var r in (this.oscillator && (this.oscillator.disconnect(), delete this.oscillator),
							(this.oscillator = s.audiocontext.createOscillator()),
					...
					(p5.Oscillator.prototype.freq = function(t, e, n) {
						if ('number' != typeof t || isNaN(t)) {
							...
							0 === e
								...
								: 0 < t
									? this.oscillator.frequency.exponentialRampToValueAtTime(t, n + e + i)
									: this.oscillator.frequency.linearRampToValueAtTime(t, n + e + i),
				...
				(p5.Oscillator.prototype.add = function(t) {
					...
					(p5.Oscillator.prototype.scale = function(t, e, n, i) {
						...
						r =
							4 === arguments.length
								? ((o = p5.prototype.map(n, t, e, 0, 1) - 0.5), p5.prototype.map(i, t, e, 0, 1) - 0.5)
								: ((o = t), e);
						var s = new p(o, r),
				...
				(p5.PolySynth = function(t, e) {
					...
					(p5.PolySynth.prototype.noteAttack = function(t, e, n) {
						...
						var i,
							...
							s = e || 0.1;
						if (
							(this.notes[r] && null !== this.notes[r].getValueAtTime(o) && this.noteRelease(r, 0),
						...
						var u =
							null === this._voicesInUse._searchBefore(o) ? 0 : this._voicesInUse._searchBefore(o).value;
						if (
						...
						if (t) {
							...
							if (this.notes[r] && null !== this.notes[r].getValueAtTime(o)) {
								...
								this._voicesInUse.setValueAtTime(s - 1, o),
									...
									this.audiovoices[this.notes[r].getValueAtTime(o)].triggerRelease(i),
		...
		(a = []),
			'function' != typeof AudioWorkletNode &&
				((self.AudioWorkletNode = function(t, e, n) {
					...
					return (
						(l = null), (o.port = u.port1), (o.processor = i), (o.instance = p), (o.onaudioprocess = c), o
					);
				}),
					...
					: ((p5.Panner = function(t, e, n) {
						...
						(p5.Panner.prototype.inputChannels = function(t) {
							1 === t
								...
								: 2 === t &&
									(o('undefined' === this.splitter) && (this.splitter = a.createChannelSplitter(2)),
							...
							(t.onload = function() {
								o.panner &&
									p.decodeAudioData(t.result, function(t) {
										o.panner &&
											((o.buffer = t), o.panner.inputChannels(t.numberOfChannels), n && n(o));
									});
							}),
							...
							if (
								...
								(o = o && (o <= this.buffer.duration - r ? o : this.buffer.duration)),
									this._paused
										...
										: (this.bufferSourceNode.start(a, r, o), this._counterNode.start(a, r, o)),
									(this._playing = !0),
									(this._paused = !1),
							...
							(h.oncomplete = function(t) {
								if (self.panner) {
									for (
										...
										(a = d(n, u)), (u -= 0.005), Object.keys(a).length < c && p <= u;
			...
			(n = function(t) {
				...
				(p5.Amplitude = function(t) {
					(this.bufferSize = e(2048)),
						...
						(this._workletNode = new AudioWorkletNode(this.audiocontext, i.amplitudeProcessor, {
				...
				(p5.FFT = function(t, e) {
					...
					(p5.FFT.prototype.waveform = function() {
						for (var t, e, n = 0; n < arguments.length; n++)
							'number' == typeof arguments[n] && ((t = arguments[n]), (this.analyser.fftSize = 2 * t)),
					...
					(p5.FFT.prototype.analyze = function() {
						...
						return t && 'db' === t.toLowerCase()
							? (n(this), this.analyser.getFloatFrequencyData(this.freqDomain), this.freqDomain)
					...
					(p5.FFT.prototype.linAverages = function(t) {
						...
						for (
							...
							(o[r] = void 0 !== o[r] ? (o[r] + e[s]) / 2 : e[s]), s % i == i - 1 && r++;
						return o;
					}),
			...
			(i = function(t) {
				...
				(p5.Envelope = function(t, e, n, i, o, r) {
					...
					(p5.Envelope.prototype.ramp = function(t, e, n, i) {
						...
						a < r
							? (this.control.setTargetAtTime(r, o, this._rampAttackTC), (o += this._rampAttackTime))
							: r < a &&
								(this.control.setTargetAtTime(r, o, this._rampDecayTC), (o += this._rampDecayTime)),
							void 0 !== s &&
								(r < s
									? this.control.setTargetAtTime(s, o, this._rampAttackTC)
									: s < r && this.control.setTargetAtTime(s, o, this._rampDecayTC));
					}),
					(p5.Envelope.prototype.connect = function(t) {
						((this.connection = t) instanceof p5.Oscillator ||
							...
							(t = t.output.gain),
							t instanceof AudioParam && t.setValueAtTime(0, u.audiocontext.currentTime),
					...
					(p5.Pulse.prototype.freq = function(t, e, n) {
						if ('number' == typeof t) {
							...
							this.oscillator.frequency.cancelScheduledValues(i),
								...
								this.osc2.oscillator.frequency.setValueAtTime(o, i + n),
								this.osc2.oscillator.frequency.exponentialRampToValueAtTime(t, n + e + i),
				...
				var n = (function() {
						for (
							var t = 2 * l.audiocontext.sampleRate,
								e = l.audiocontext.createBuffer(1, t, l.audiocontext.sampleRate),
								n = e.getChannelData(0),
								i = 0;
							i < t;
							i++
				...
				(r.inputSources = []),
					...
					(p5.AudioIn.prototype.start = function(e, n) {
						...
						var t = r.inputSources[i.currentSource],
							o = { audio: { sampleRate: r.audiocontext.sampleRate, echoCancellation: !1 } };
						r.inputSources[this.currentSource] && (o.audio.deviceId = t.deviceId),
							window.navigator.mediaDevices
								.getUserMedia(o)
								.then(function(t) {
									(i.stream = t),
					...
					(p5.AudioIn.prototype.amp = function(t, e) {
						if (e) {
							...
							this.output.gain.cancelScheduledValues(r.audiocontext.currentTime),
								this.output.gain.setValueAtTime(i, r.audiocontext.currentTime),
								this.output.gain.linearRampToValueAtTime(t, n + r.audiocontext.currentTime);
						} else
							this.output.gain.cancelScheduledValues(r.audiocontext.currentTime),
					...
					(p5.AudioIn.prototype.setSource = function(t) {
						0 < r.inputSources.length && t < r.inputSources.length && (this.currentSource = t),
	...
	function(t, e, n) {
		var i, o;
		(i = [ n(0), n(7), n(16), n(3), n(53), n(26), n(54), n(25), n(55), n(56), n(57) ]),
			void 0 ===
				(o = function(u) {
					'use strict';
					function n(t, e, n) {
								...
								for (var e in u.Expr._Expressions) {
									...
									for (var i in n) {
										var o = n[i],
											r = o.regexp,
											s = t.match(r);
										if (null !== s) return { type: e, value: s[0], method: o.method };
									}
								}
				...
				(o = function(t) {
					...
					return (
						...
						(t.EqualPowerGain.prototype.dispose = function() {
							return (
								t.prototype.dispose.call(this), this._eqPower.dispose(), (this._eqPower = null), this
							);
						}),
						t.EqualPowerGain
					);
						...
						for (var o = 0; o < t; o++)
							(i =
								o === t - 1
									...
									: 0 === o
										? ((n = 100), 0.1)
										: ((n = 1 === o ? (3 === t ? 360 * e : 360) : this.bands[o - 1].freq() * e), 1)),
			...
			(i = function(t) {
				...
				(p5.Reverb = function() {
					...
					(p5.Convolver.prototype.dispose = function() {
						for (var t in (p5.Reverb.prototype.dispose.apply(this), this.impulses))
	...
	function(t, e, n) {
		...
		void 0 ===
			(i = function(t) {
				...
				function o(t) {
					for (
						var e, n = 'number' == typeof t ? t : 50, i = new Float32Array(44100), o = Math.PI / 180, r = 0;
						r < 44100;
						++r
					)
						(e = 2 * r / 44100 - 1), (i[r] = (3 + n) * e * 20 * o / (Math.PI + n * Math.abs(e)));
					return i;
				}
